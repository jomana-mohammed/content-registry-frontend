...
const Login = () => {
    ...
    <div className="flex min-h-screen justify-center items-center px-6 sm:px-10">
      <div className="flex w-full max-w-[350px] sm:max-w-md lg:max-w-[500px] flex-col justify-center items-center px-6 py-12 lg:px-8 bg-white rounded-lg shadow-lg">
